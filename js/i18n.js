...
(function () {
  ...
  var strings = {
    en: {
      ...
      /* ---- Oliver's jokes (20) ---- */
      joke1: 'Why do fish live in salt water?\nBecause pepper makes them sneeze!',
      joke2: 'What do you call a fish without eyes?\nA fsh!',
      joke3: 'What do sea monsters eat for lunch?\nFish and ships!',
      joke4: 'Why did the octopus beat the shark in a fight?\nBecause it was well armed!',
      joke5: "What lies at the bottom of the ocean and twitches?\nA nervous wreck!",
      joke6: 'How do oysters call their friends?\nOn shell phones!',
      joke7: 'What do you call a lazy crayfish?\nA slobster!',
      joke8: "Why don't oysters share their toys?\nBecause they're shellfish!",
      joke9: "What's a fish's favorite instrument?\nA bass guitar!",
      joke10: 'What did the ocean say to the beach?\nNothing, it just waved!',
      joke11: 'Where do fish keep their money?\nIn a river bank!',
      joke12: 'What do you get from a bad-tempered shark?\nAs far away as possible!',
      joke13: 'Why are fish so smart?\nBecause they swim in schools!',
      joke14: "What did one tide pool say to the other?\n\"Show me your mussels!\"",
      joke15: "Why don't fish play basketball?\nThey're afraid of the net!",
      joke16: 'What do whales like to chew?\nBlubber gum!',
      joke17: 'How do you make an octopus laugh?\nWith ten-tickles!',
      joke18: 'What kind of fish chases mice?\nA catfish!',
      joke19: 'What do you call a fish wearing a crown?\nYour royal high-ness!',
      joke20: 'Why did the crab never share?\nBecause he was a little shellfish!',
    ...
    ja: {
      ...
      /* ---- オリバーのジョーク (20) ---- */
      joke1: 'さかなはなぜ うみにすんでるの？\nこしょうだと くしゃみがでるから！',
      joke2: 'めのないさかなは なんていう？\nめがないさかな！',
      joke3: 'うみのかいぶつは なにをたべる？\nフィッシュ アンド シップス！',
      joke4: 'タコがサメにかったのは なぜ？\nうでがたくさんあるから！',
      joke5: 'うみのそこで ぶるぶるしてるのは？\nしんけいがやられたひと！',
      joke6: 'カキは ともだちに どうやってでんわする？\nシェルフォンで！',
      joke7: 'なまけもののザリガニは なんていう？\nぐうたらザリガニ！',
      joke8: 'カキは なぜ おもちゃをかさないの？\nかいがらが かたいから！',
      joke9: 'さかなのすきな がっきは？\nベースギター！',
      joke10: 'うみは ビーチに なんていった？\nなにもいわず てをふっただけ！',
      joke11: 'さかなは どこに おかねを しまうの？\nかわぎん(川銀)こう！',
      joke12: 'きげんのわるい サメに あったら どうする？\nできるだけ とおくに にげる！',
      joke13: 'さかなは なぜ あたまが いいの？\nいつも がっこう(群れ)で およいでるから！',
      joke14: 'しおだまりが もういっぽうに なんていった？\n「きんにく(ムール貝)を みせて！」',
      joke15: 'さかなは なぜ バスケを しないの？\nあみが こわいから！',
      joke16: 'クジラの だいすきな ガムは？\nあぶらみガム！',
      joke17: 'タコを わらわせるには？\n１０ぽんの くすぐりで！',
      joke18: 'ネズミを おいかける さかなは？\nキャットフィッシュ（なまず）！',
      joke19: 'かんむりを かぶった さかなは？\nおさかなさま(王)！',
      joke20: 'カニは なぜ わけあわないの？\nちょっと ケチ(かいがら)だから！',
